...
export type CreateMedicationDto = Omit<MedicationEntity, "id" | "patient" | "createdAt" | "updatedAt"> &
...
export class MedicationService {
  ...
  async list(patientId?: string): Promise<MedicationEntity[]> {
  ...
  async create(dto: CreateMedicationDto): Promise<MedicationEntity> {
    ...
    const { patient: _p, createdAt: _c, updatedAt: _u, ...rest } = dto as MedicationEntity;
